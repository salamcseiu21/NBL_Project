...
namespace NblClassLibrary.DAL
{
    public class ProductGateway:DbGateway
    {
        ...
        internal int ApproveTransferIssue(TransferIssue transferIssue)
        {
            try
            {
        ...
        internal int IssueProductToTransfer(TransferIssue aTransferIssue)
        {
            ConnectionObj.Open();
        ...
        internal IEnumerable<TransferIssueDetails> GetTransferIssueDetailsById(int id)
        {
            try
            {
        ...
        internal IEnumerable<TransferIssue> GetTransferIssueList()  
        {
            try
            {
