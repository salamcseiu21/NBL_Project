...
namespace NblClassLibrary.DAL
{
    public class ClientGateway:DbGateway
    {
        ...
        internal int Save(Client client)
        {
            try
            {
                ConnectionObj.Open();
        ...
        internal List<Client> GetPendingClients()
        {
            try
            {
        ...
        internal IEnumerable<Client> GetAll
        {
            get
            {
                try
                {
                    ...
                    while (reader.Read())
                    {
                        clients.Add(new Client
                        {
                            ...
                            Orders = _orderManager.GetOrdersByClientId(Convert.ToInt32(reader["ClientId"])).ToList(),
        ...
        internal int Update(int id, Client client)
        {
            try
            {
                CommandObj.Parameters.Clear();
        ...
        internal ViewClient GetClientDeailsById(int clientId) 
        {
