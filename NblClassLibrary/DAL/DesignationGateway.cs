...
namespace NblClassLibrary.DAL
{
    public class DesignationGateway:DbGateway
    {
        ...
        internal Designation GetDesignationByCode(string code)
        {
            try
            {
        ...
        internal Designation GetDesignationById(int designationId)
        {
            try
            {
        ...
        internal int Update(Designation aDesignation)
        {
            try
            {
        ...
        internal int Save(Designation aDesignation)
        {
            try
            {
